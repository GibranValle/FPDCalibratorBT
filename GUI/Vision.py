...
class Vision(CTk):
    ...
    def __init__(self, app: GUI):
        ...
        self.vision_label.grid(row=0, column=0, pady=(20, 5), sticky="NW", padx=10)  # type: ignore
        self.ventana_label.grid(row=1, column=0, pady=(5, 5), sticky="W", padx=10)  # type: ignore
        self.status_label.grid(row=2, column=0, pady=(5, 20), sticky="SW", padx=10)  # type: ignore
